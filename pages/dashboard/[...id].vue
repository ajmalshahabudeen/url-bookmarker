<template>
    <div>
        ...
        <div class="flex md:flex-row md:gap-5 md:mx-10 p-0 ">
          ...
          <UContainer
            class="p-5 md:p-20 flex flex-wrap gap-5 max-h-[80vh] overflow-y-auto custom-scrollbar w-full"
            v-if="FilterStore.filter === 'category'">
            <p
                v-if="
                    BookCatStore.categoryData.length === 0 &&
                    !BookCatStore.loading
                ">
                No Categories yet
            </p>
                ...
                <div
                    ...
                    <UModal v-model="isDelUrlOpen">
                        <div class="flex flex-col gap-5 p-5">
                            ...
                            <div
                                class="flex items-center w-full justify-end gap-5">
                                <UButton
                                    label="Close"
                                    class="mt-5"
                                    type="button"
...
import FilePath from "~/components/sidebar/filePath.vue";
